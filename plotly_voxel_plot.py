# stolen from https://github.com/elerator/plotly_voxel_plot 
# shoutout elerator 
...
def get_planes(tensor):
    ...
    top_plane_voxel = np.zeros(tensor.shape, dtype=bool)
    bottom_plane_voxel = np.zeros(tensor.shape, dtype=bool)
    left_plane_voxel = np.zeros(tensor.shape, dtype=bool)
    right_plane_voxel = np.zeros(tensor.shape, dtype=bool)
    back_plane_voxel = np.zeros(tensor.shape, dtype=bool)
    front_plane_voxel = np.zeros(tensor.shape, dtype=bool)
...
def get_surface_voxels(tensor):
    ...
    top_voxels = np.zeros(tensor.shape, dtype=bool)
    bottom_voxels = np.zeros(tensor.shape, dtype=bool)
    left_voxels = np.zeros(tensor.shape, dtype=bool)
    right_voxels = np.zeros(tensor.shape, dtype=bool)
    back_voxels = np.zeros(tensor.shape, dtype=bool)
    front_voxels = np.zeros(tensor.shape, dtype=bool)
